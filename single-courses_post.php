...
/**Archives file name examples.
archive-courses_post.php
archive.php
index.php

Single Posts file name examples.
single-courses_post_slug.php *
single-courses_post.php
single.php
singular.php
index.php

*Replace "post_slug" with the slug of the actual post.
...
?>
<h1> Test Single Courses Page works !!!</h1>
  ...
  <div class="row g-5">
    <div class="col-md-8">
      <div class="pb-4 mb-4 fst-italic border-bottom">
        ...
        <p class="text-muted">Posted on: <?php the_time('d M Y'); ?></p> <!-- the time format from wordpress codex -->
